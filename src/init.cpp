...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Viptocoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  viptocoind [options]                     " + "\n" +
                  "  viptocoind [options] <command> [params]  " + _("Send command to -server or viptocoind") + "\n" +
                  "  viptocoind [options] help                " + _("List commands") + "\n" +
                  "  viptocoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: viptocoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: viptocoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 1222 or testnet: 11222)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 1221 or testnet: 11221)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Viptocoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Viptocoin is probably already running."), strDataDir.c_str()));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("Viptocoin version %s (%s)\n", FormatFullVersion().c_str(), CLIENT_DATE.c_str());
